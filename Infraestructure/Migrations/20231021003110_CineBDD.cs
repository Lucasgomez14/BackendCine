...
{
    /// <inheritdoc />
    public partial class CineBDD : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 5, 3, "https://raw.githubusercontent.com/Lucasgomez14/complementosImagenes/main/imagenesTP3/is5.jpg", "En un futuro donde la Tierra se enfrenta a la escasez de recursos y la decadencia ambiental, un grupo de exploradores espaciales liderados por el piloto Cooperse embarca en una misión interestelar para encontrar un nuevo hogar para la humanidad.", "Interestelar", "https://www.youtube.com/watch?v=LYS2O1nl9iM" },
                    { 6, 3, "https://raw.githubusercontent.com/Lucasgomez14/complementosImagenes/main/imagenesTP3/op6.jpg", "En tiempos de guerra, el brillante físico estadounidense Julius Robert Oppenheimer, al frente del proyecto Manhattan, lidera los ensayos nucleares para construir la bomba atómica para su país.", "OppenHeimer", "https://www.youtube.com/watch?v=MVvGSBKV504" },
                    ...
                    { 8, 4, "https://raw.githubusercontent.com/Lucasgomez14/complementosImagenes/main/imagenesTP3/ma8.jpg", "Matrix presenta a Neo, un programador de software que, se une a un grupo de rebeldes que luchan contra una inteligencia artificial que ha esclavizado a la humanidad en una realidad simulada llamada la Matriz.", "Matrix", "https://www.youtube.com/watch?v=sMkNB8v-0uQ" },
                    { 9, 5, "https://raw.githubusercontent.com/Lucasgomez14/complementosImagenes/main/imagenesTP3/pa9.jpg", "Kevin McCallister es un niño de ocho años que es accidentalmente dejado atrás cuando su familia se va de vacaciones durante la Navidad. Mientras se encuentra solo en casa, Kevin debe defender su hogar de dos torpes ladrones que intentan robarlo.", "Mi Pobre Angelito", "https://www.youtube.com/watch?v=KSpCNBIo92A" },
                    ...
                    { 13, 7, "https://raw.githubusercontent.com/Lucasgomez14/complementosImagenes/main/imagenesTP3/ll13.jpg", "La Lista de Schindler está basada en la historia real de Oskar Schindler, un empresario alemán que salvó la vida de más de mil judíos durante el Holocausto al emplearlos en sus fábricas.", "La Lista de Schindler", "https://www.youtube.com/watch?v=7q-ETFeMxwI" },
                    { 14, 7, "https://raw.githubusercontent.com/Lucasgomez14/complementosImagenes/main/imagenesTP3/rm14.jpg", "Dirigida por Paulina García, Mujer en Llamas sigue a Ema , una joven bailarina que está decidida a recuperar a su hijo después de que su adopción se rompe.", "Mujer en Llamas", "https://www.filmaffinity.com/es/film218131.html" },
                    { 15, 8, "https://raw.githubusercontent.com/Lucasgomez14/complementosImagenes/main/imagenesTP3/sa15.jpg", "Basada en la novela de J.R.R. Tolkien, esta película dirigida por Peter Jackson sigue la épica aventura de Frodo Baggins y un variado grupo de personajes mientras intentan destruir un poderoso anillo que podría sumir al mundo en la oscuridad.", "El Señor de los Anillos: La Comunidad del Anillo", "https://www.youtube.com/watch?v=3GJp6p_mgPo" },
                    { 16, 8, "https://raw.githubusercontent.com/Lucasgomez14/complementosImagenes/main/imagenesTP3/lb16.jpg", "El Laberinto del Fauno se desarrolla en la posguerra de España y sigue a Ofelia, una niña que descubre un mundo mágico y misterioso en un laberinto cerca de su nuevo hogar.", "El Laberinto del Fauno", "https://www.youtube.com/watch?v=gpEh4O8Hb5Y" },
                    { 17, 9, "https://raw.githubusercontent.com/Lucasgomez14/complementosImagenes/main/imagenesTP3/gs17.jpg", "El Gran Showman narra la historia de cómo Barnum creó el circo que eventualmente se convertiría en el famoso Circo Barnum & Bailey.", "El Gran Showman", "https://www.youtube.com/watch?v=uprrVIIT0G8" },
                    { 18, 9, "https://raw.githubusercontent.com/Lucasgomez14/complementosImagenes/main/imagenesTP3/lm18.jpg", "Los Miserables sigue las vidas entrelazadas de varios personajes en la Francia del siglo XIX. La película se centra en la historia de Jean Valjean), un exconvicto que busca redimirse mientras es perseguido por el inspector Javert (Russell Crowe)..", "Los Miserables", "https://www.youtube.com/watch?v=EZngbEj3W1Y" },
                    { 19, 10, "https://raw.githubusercontent.com/Lucasgomez14/complementosImagenes/main/imagenesTP3/sv19.jpg", "Dirigida por Jim Gillespie, esta película sigue a un grupo de amigos que, después de un trágico accidente automovilístico en el que atropellan a un hombre, deciden ocultar su crimen y juran guardar el secreto.", "Sé lo que Hicieron el Verano Pasado", "https://www.youtube.com/watch?v=_y6H2ybiEvs" },
                    { 20, 10, "https://raw.githubusercontent.com/Lucasgomez14/complementosImagenes/main/imagenesTP3/sc20.jpg", "Basada en la novela de Thomas Harris, esta película presenta a la joven agente del FBI Clarice Starling mientras busca la ayuda del brillante pero psicótico asesino en serie Hannibal Lecter para atrapar a otro asesino en serie conocido como Buffalo Bill.", "El Silencio de los Corderos", "https://www.youtube.com/watch?v=3VZa6KAxE1I" },
                    { 21, 11, "https://raw.githubusercontent.com/Lucasgomez14/complementosImagenes/main/imagenesTP3/ee21.jpg", "El Exorcista es un clásico del terror que sigue la historia de Regan, una niña poseída por una entidad demoníaca. La película sigue los esfuerzos de un sacerdote y un psiquiatra para exorcizar al demonio que ha tomado control del cuerpo de la niña.", "El Exorcista", "https://www.youtube.com/watch?v=gYApro2YXQQ" },
                    { 22, 11, "https://raw.githubusercontent.com/Lucasgomez14/complementosImagenes/main/imagenesTP3/ec22.jpg", "El Conjuro está basada en casos reales de los investigadores paranormales Ed y Lorraine Warren. La película sigue a los Warren ) mientras investigan una serie de eventos sobrenaturales aterradores que ocurren en la casa de una familia.", "El Conjuro", "https://www.youtube.com/watch?v=_zU1gLWGnpg" }
                });
